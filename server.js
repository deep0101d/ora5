// server.js
// Express backend using Google Gemini for EDU AI Lab
// Endpoints:
...
// Good general model; you can swap to "gemini-1.5-pro" if available in your region
...
async function readPdf(fp) {
  const data = await pdf(await fs.promises.readFile(fp));
  return data.text || '';
}
